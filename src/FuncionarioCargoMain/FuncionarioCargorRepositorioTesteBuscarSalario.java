 ...
 * @author Danilo
 */
public class FuncionarioCargorRepositorioTesteBuscarSalario {
    public static void main(String[] args) {
        FuncionarioCargoRepositorio funcionarioCargoRepositorio = new FuncionarioCargoRepositorio();
         List<FuncionarioCargo> funcionarioCargos = funcionarioCargoRepositorio.buscarPorSalario("600,000");
